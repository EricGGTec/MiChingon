    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (DetallePedido detallePedidoCollectionOrphanCheckDetallePedido : detallePedidoCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Pedido (" + pedido + ") cannot be destroyed since the DetallePedido " + detallePedidoCollectionOrphanCheckDetallePedido + " in its detallePedidoCollection field has a non-nullable idPedido field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
